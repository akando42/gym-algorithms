...
class ACSAgent:
	def __init__(self):
		...
		self.lr_qvalue      = 0.001  # state action value learning rate
	...
	def calc_target(self, mini_batch):
		# print("Update State Action Value")
	...
	def train_agent(self):
		...
		# print("Updating Policy with TD Target ", td_target.shape)
		# print("S Batch" ,s_batch.shape)
		# print("A Batch", a_batch.shape)
...
if __name__ == '__main__':
	...
	for epoc in range(epocs):
		...
		if epoc % 5 == 0:
			torch.save(agent.PI.state_dict(), model_dir + "/acs_optimal"+str(epoc)+".pt")
